...
\texttt{slow\-All\-Enemies()} kapseln die jeweilige Implementierungslogik, etwa
...
Die acht Kartenklassen, \texttt{Damage\-Buff\-Card}, \texttt{Range\-Buff\-Card},
\texttt{FreezeCard}, \texttt{EnergyCard}, \texttt{GoldCard}, \texttt{DrawCard},
\texttt{DiscountCard} und \texttt{Build\-Tower\-Card}, sind alle nach demselben
...
aus phasen\-abhängigen Bedingungen verwalten: Karten dürfen nur in bestimmten
