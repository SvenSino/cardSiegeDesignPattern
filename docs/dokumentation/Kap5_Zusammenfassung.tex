...
Das System bietet konkrete Ansatzpunkte für Erweiterungen. Das Command-Pattern
legt die Grundlage für eine Undo-Funktion: Eine \texttt{undo()}-Methode auf
\texttt{Card} würde Kartenaktionen rückgängig machbar machen. Das
Memento-Pattern böte eine elegante Basis für Spielstand-Speicherung. Ein Adapter
könnte einen externen Pathfinding-Algorithmus wie A* anbinden, ohne das
\texttt{Board} zu modifizieren. Neue Karten- und Turmtypen hingegen lassen sich
bereits heute ohne Änderung am Bestand ergänzen -- das direkte Ergebnis
konsequenter Pattern-Anwendung.
